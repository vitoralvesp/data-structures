...
public class Main {
	...
	public static void main(String[] args) {
		...
		int menu_option;
		DinamicStack<String> string_stack = null;
		DinamicStack<Integer> integer_stack = null;
		DinamicStack<Boolean> boolean_stack = null;
		DinamicStack<Float> float_stack = null;
		...
		case 1 -> string_stack = new DinamicStack<>();
		case 2 -> integer_stack = new DinamicStack<>();
		case 3 -> boolean_stack = new DinamicStack<>();
		case 4 -> float_stack = new DinamicStack<>();	
		}
